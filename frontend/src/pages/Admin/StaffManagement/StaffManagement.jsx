...
const Staff = () => {
  ...
  const fetchStaff = async () => {
    try {
      const res = await axios.get(`${config.server}/staff/all`,{
      headers: {
  ...
  const addStaff = async (data) => {
    try {
      await axios.post(`${config.server}/staff/add`, data,
        {
      headers: {
        Authorization: `Bearer ${token}`,
      },
  ...
  const updateStaff = async (data) => {
    try {
      await axios.put(
        `${config.server}/staff/update/${editingStaff.id}`,
        data,
        {
          headers: {
            Authorization: `Bearer ${token}`,
